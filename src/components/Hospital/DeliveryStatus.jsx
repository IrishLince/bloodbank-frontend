...
import { Search, Filter, Calendar, Truck, Package, Eye, Clock, CheckCircle, AlertTriangle, ArrowRight, MapPin, Building } from 'lucide-react';
import Header from '../Header';

// Delivery status constants (matching RedsourceAdmin)
...
export default function DeliveryStatus() {
  ...
  // Mock data for deliveries (this would come from RedsourceAdmin system)
  const mockDeliveries = [
    {
      ...
      driverContact: '(555) 111-2222',
      vehicleId: 'VH-001',
      deliveredDate: '2023-11-20',
      deliveredTime: '2:45 PM',
      notes: 'Emergency delivery completed successfully',
      trackingHistory: [
        { timestamp: '2023-11-20T14:00:00', status: 'Scheduled', location: 'Blood Bank', note: 'Delivery scheduled' },
        { timestamp: '2023-11-20T14:15:00', status: 'In Transit', location: 'En route', note: 'Driver departed from blood bank' },
        { timestamp: '2023-11-20T14:45:00', status: 'Complete', location: 'Hospital', note: 'Delivery completed and received' }
      ]
    },
    {
      id: 'DEL-1002',
      ...
      driverContact: '(555) 333-4444',
      vehicleId: 'VH-002',
      currentLocation: 'Highway 95, 5 miles from hospital',
      estimatedArrival: '10:35 AM',
      notes: 'Regular inventory replenishment in progress',
      trackingHistory: [
        { timestamp: '2023-11-21T10:00:00', status: 'Scheduled', location: 'Blood Bank', note: 'Delivery scheduled' },
        { timestamp: '2023-11-21T10:15:00', status: 'In Transit', location: 'En route', note: 'Driver departed from blood bank' }
      ]
    },
    {
      id: 'DEL-1003',
      ...
      items: 'B+ (2 units), AB- (1 unit), A- (3 units)',
      bloodItems: [
        { bloodType: 'B+', units: 2 },
        { bloodType: 'AB-', units: 1 },
        { bloodType: 'A-', units: 3 }
      ],
      ...
      driverContact: '(555) 555-6666',
      vehicleId: 'VH-003',
      notes: 'Routine stock maintenance delivery',
      trackingHistory: [
        { timestamp: '2023-11-22T08:00:00', status: 'Scheduled', location: 'Blood Bank', note: 'Delivery scheduled for 2:00 PM' }
      ]
    },
    {
      id: 'DEL-1004',
      ...
      items: 'A+ (2 units) - Partial delivery',
      bloodItems: [
        { bloodType: 'A+', units: 2 }
      ],
      scheduledDate: '2023-11-23',
      estimatedTime: 'TBD',
      status: DELIVERY_STATUS.PENDING,
      priority: 'High',
      notes: 'Partial fulfillment - remaining units B- (2 units) pending availability',
      pendingItems: [
        { bloodType: 'B-', units: 2 }
      ],
      trackingHistory: [
        { timestamp: '2023-11-19T09:00:00', status: 'Pending', location: 'Blood Bank', note: 'Partial stock available, scheduling partial delivery' }
      ]
    }
  ];
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-2">
              ...
              <div className="flex gap-2">
                ...
                >
                  ...
                  <option value={DELIVERY_STATUS.SCHEDULED}>Scheduled</option>
                  ...
                  <tbody className="bg-white divide-y divide-red-50">
                    {filteredDeliveries.map((delivery, index) => (
                      <tr key={delivery.id} className={`hover:bg-red-50 transition-colors ${index % 2 === 0 ? 'bg-white' : 'bg-red-25'}`}>
                        ...
                        <td className="px-3 py-3 whitespace-nowrap">
                          <div className="text-sm text-gray-900 max-w-xs truncate font-medium" title={delivery.items}>
                            {delivery.items}
                          </div>
                        </td>
                        <td className="px-3 py-3 whitespace-nowrap">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <p><span className="font-medium">Contact:</span> {selectedDelivery.contactInfo}</p>
                    </div>
                  </div>
                </div>
